...
function DatePicker(props) {
    ...
    function renderTimePicker() {
        ...
        return (react_1.default.createElement("div", { className: prefixCls + "-timepicker" },
            ...
            react_1.default.createElement(time_picker_1.default, __assign({}, timepickerProps, showTimeProps, disabledTimeProps, { hideFooter: true, format: timeFormat, valueShow: timeValue.format(timeFormat), onSelect: onTimePickerSelect, onConfirmValue: props.onConfirmValue, popupVisible: popupVisible, utcOffset: utcOffset, timezone: timezone }))));
    }
