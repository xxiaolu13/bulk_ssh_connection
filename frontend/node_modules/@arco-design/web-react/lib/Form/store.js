        ...
        this.setFields = function (obj) {
            ...
            fields.forEach(function (field) {
                ...
                if (item) {
                    ...
                    if ('value' in item) {
                        var control = _this.getRegisteredField(field);
                        if (control && (0, is_1.isFunction)((_b = control.props) === null || _b === void 0 ? void 0 : _b.normalize)) {
                            var prevFieldValue = _this.getFieldValue(field);
                            var allValues = _this.getFieldsValue();
                            nextValue = control.props.normalize(nextValue, prevFieldValue, __assign({}, allValues));
                        }
                        (0, utils_1.set)(_this.store, field, nextValue);
                    ...
                    _this.notify('setFieldValue', {
                        ...
                        prev: prev,
                        field: field,
                        changeValues: (_a = {}, _a[field] = nextValue, _a),
                    });
                }
            });
