...
exports.ID_SUFFIX = exports.isFieldMatch = exports.schemaValidate = exports.isSyntheticEvent = exports.iterativelyGetKeys = exports.get = exports.set = exports.formatValidateMsg = exports.cloneDeep = void 0;
...
function set(target, field, value) {
    var isBracketLeadingLiteral = typeof field === 'string' && /^\[[^'"`]/.test(field);
    var path = isBracketLeadingLiteral ? [field] : field;
    (0, set_1.default)(target, path, cloneDeep(value));
    return target;
}
exports.set = set;
function get(target, field, defaultValue) {
    var isBracketLeadingLiteral = typeof field === 'string' && /^\[[^'"`]/.test(field);
    var path = isBracketLeadingLiteral ? [field] : field;
    return (0, get_1.default)(target, path, defaultValue);
}
exports.get = get;
            ...
            return [2 /*return*/, new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        ...
                        validate = function (rule) { return __awaiter(_this, void 0, void 0, function () {
                            var next, _rule, isNumberValue, hasNumberSemantics, schema;
                            var _a, _b;
                            return __generator(this, function (_c) {
                                ...
                                if (!_rule.type && !_rule.validator) {
                                    ...
                                    hasNumberSemantics = _rule.min !== undefined ||
                                        _rule.max !== undefined ||
