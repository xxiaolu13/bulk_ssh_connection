...
function Modal(baseProps, ref) {
    ...
    var element = (react_1.default.createElement(ConfigProvider_1.default, __assign({}, context, { effectGlobalModal: false, effectGlobalNotice: false, prefixCls: props.prefixCls || context.prefixCls, locale: locale, zIndex: popupZIndex || 1050, getPopupContainer: function (node) {
