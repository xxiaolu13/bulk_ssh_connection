...
function Td(props) {
    ...
    var content = (react_1.default.createElement(react_1.default.Fragment, null,
        ...
        (0, is_1.isString)(ComponentBodyCell) ? (react_1.default.createElement(ComponentBodyCell, __assign({}, { className: prefixCls + "-cell-wrap-value" }), cellChildren)) : (react_1.default.createElement(ComponentBodyCell, __assign({ rowData: (0, utils_1.getOriginData)(record), className: prefixCls + "-cell-wrap-value", column: column, onHandleSave: onHandleSave }, cellProps), cellChildren))));
    return (react_1.default.createElement(InnerComponentTd, __assign({ key: column.key || column.dataIndex || columnIndex, onMouseEnter: function (e) {
            var _a;
            if (rowSpan > 1) {
        ...
        'onMouseDown',
        'onMouseUp',
    ]), tdProps, { className: (0, classNames_1.default)(classNameTd, tdProps.className), style: __assign(__assign({}, styleTd), tdProps.style) }),
