...
function Tr(props, ref) {
    ...
    var getPrefixColClassName = function (name, index) {
        var _a;
        return (0, classNames_1.default)(operationClassName, prefixCls + "-" + name, (_a = {},
            ...
            _a[prefixCls + "-col-first"] = index === 0,
            _a));
    };
    ...
    function renderExpandIcon(record, rowK) {
        ...
        if (typeof expandIcon === 'function') {
            var customIcon = expandIcon(__assign({ expanded: expanded, record: record }, onClickProps));
            if (react_1.default.isValidElement(customIcon)) {
                return react_1.default.cloneElement(customIcon, __assign(__assign({}, onClickProps), customIcon.props));
            }
            return customIcon;
        }
        return (react_1.default.createElement("button", __assign({}, onClickProps, { type: "button" }), expanded ? react_1.default.createElement(IconMinus_1.default, null) : react_1.default.createElement(IconPlus_1.default, null)));
    }
    var expandNode = expandedRowRender && (react_1.default.createElement(InnerComponentTd, { className: getPrefixColClassName('expand-icon-cell', 0) }, shouldRenderExpandRow && renderExpandIcon(record, rowK)));
    ...
    if (type === 'checkbox') {
        selectionNode = (react_1.default.createElement(InnerComponentTd, { className: getPrefixColClassName('checkbox', expandNode ? 1 : 0) }, renderSelectionCell
            ? renderSelectionCell(checkboxNode, checked, originRecord)
            : checkboxNode));
    }
    if (type === 'radio') {
        selectionNode = (react_1.default.createElement(InnerComponentTd, { className: getPrefixColClassName('radio', expandNode ? 1 : 0) }, renderSelectionCell ? renderSelectionCell(radioNode, checked, originRecord) : radioNode));
    }
    ...
    return (react_1.default.createElement(InnerComponentBodyRow, __assign({}, trProps, { ref: ref }), columns.map(function (col, colIndex) {
        ...
        if (col.$$isOperation) {
            ...
            if (col.title === constant_1.INTERNAL_SELECTION_KEY) {
                node = (_c = bodyOperations.find(function (o) { return o.name === 'selectionNode'; })) === null || _c === void 0 ? void 0 : _c.node;
                isExtraOperation = false;
            }
            if (col.title === constant_1.INTERNAL_EXPAND_KEY) {
                node = (_d = bodyOperations.find(function (o) { return o.name === 'expandNode'; })) === null || _d === void 0 ? void 0 : _d.node;
                isExtraOperation = false;
            }
            var operationNode = typeof node === 'function' ? node(record) : node;
            return react_1.default.cloneElement(operationNode, __assign(__assign({ key: col.key || colIndex }, operationNode.props), { className: (0, classNames_1.default)(isExtraOperation ? operationClassName : '', (_e = operationNode === null || operationNode === void 0 ? void 0 : operationNode.props) === null || _e === void 0 ? void 0 : _e.className, stickyClassName, (_a = {},
                    _a[prefixCls + "-col-first"] = colIndex === 0,
                    _a)), style: __assign(__assign(__assign({}, (_f = operationNode === null || operationNode === void 0 ? void 0 : operationNode.props) === null || _f === void 0 ? void 0 : _f.style), (col.fixed === 'left'
                    ? (_b = {},
                        _b[rtl ? 'right' : 'left'] = stickyOffset,
                        _b) : {})), { width: col.width, minWidth: col.width }) }));
        }
