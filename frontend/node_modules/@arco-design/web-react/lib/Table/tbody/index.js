...
var DataRecordRenderer = (0, react_1.forwardRef)(function (_a, ref) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, { key: rowK },
        ...
        shouldRenderExpandIcon && (react_1.default.createElement(TRTagName, { key: rowK + "-expanded", className: (0, classNames_1.default)(prefixCls + "-tr", prefixCls + "-expand-content") },
            react_1.default.createElement(TDTagName, { className: (0, classNames_1.default)(prefixCls + "-td", prefixCls + "-col-first"), style: { paddingLeft: indentSize }, colSpan: columns.length }, hasFixedColumn ? (react_1.default.createElement("div", { className: prefixCls + "-expand-fixed-row", style: { width: tableViewWidth } }, er === null || er === void 0 ? void 0 : er(record, index))) : (er === null || er === void 0 ? void 0 : er(record, index)))))));
});
function TBody(props) {
    ...
    var noDataTr = (react_1.default.createElement("tr", { className: (0, classNames_1.default)(prefixCls + "-tr", prefixCls + "-empty-row") },
        react_1.default.createElement("td", { className: (0, classNames_1.default)(prefixCls + "-td", prefixCls + "-col-first"), colSpan: columns.length },
            react_1.default.createElement("div", __assign({}, noElementProps), noDataElement))));
    var renderDataRecord = function (record, index) {
        var _a;
        return (react_1.default.createElement(DataRecordRenderer, { key: (_a = getRowKey(record)) !== null && _a !== void 0 ? _a : index, record: record, index: index, virtualized: virtualized, tbodyProps: props }));
    };
