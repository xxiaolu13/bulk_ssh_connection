...
function Drawer(baseProps, ref) {
    ...
    var _j = __read((0, react_1.useState)(false), 2), isRendered = _j[0], setIsRendered = _j[1];
    ...
    var forceRender = isFirstRender.current ? !mountOnEnter : isRendered;
    if (!visible && !forceRender) {
        return null;
    }
    return (react_1.default.createElement(Portal_1.default, { forceRender: forceRender, visible: visible, getContainer: getPopupContainer },
            ...
            react_1.default.createElement(CSSTransition_1.default, { in: visible, appear: true, timeout: 300, classNames: {
                ...
                react_1.default.createElement("div", { className: (0, classNames_1.default)(prefixCls, className, (_c = {}, _c[prefixCls + "-rtl"] = rtl, _c)), style: Object.assign(placement === 'left' || placement === 'right' ? { width: width } : { height: height }, (_d = {}, _d[placement] = 0, _d), style) },
                    react_1.default.createElement("div", { className: prefixCls + "-inner" },
                        react_1.default.createElement(ConfigProvider_1.default, __assign({}, context, { effectGlobalModal: false, effectGlobalNotice: false, zIndex: popupZIndex || 1050 }), dom)))))));
}
