...
var Trigger = /** @class */ (function (_super) {
    ...
    Trigger.prototype.render = function () {
        ...
        var rawPopupChildren = popup();
        var popupChildren;
        if (react_1.default.isValidElement(rawPopupChildren)) {
            popupChildren = rawPopupChildren;
        }
        else if ((0, is_1.isArray)(rawPopupChildren)) {
            popupChildren = rawPopupChildren.find(function (n) { return react_1.default.isValidElement(n); }) || react_1.default.createElement("span", null);
        }
        else {
            popupChildren = react_1.default.createElement("span", null);
        }
        var childProps = react_1.default.isValidElement(child) ? child.props : undefined;
        var childClassName = childProps && typeof childProps.className === 'string'
